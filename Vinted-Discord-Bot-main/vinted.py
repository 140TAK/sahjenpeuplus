            ...
            try:
                ...
                for i in range(8, 0, -1):
                    ...
                    if str(post) in posting:
                        ...
                        data = {"username": "Centrale Montmartre VINTED",
                                "avatar_url": "https://media.discordapp.net/attachments/868897295540826224/956250968499040307/182205772_150344853763531_8711038475481521603_n.png",
                                "embeds": [
                                    {
                                        "description": f"```fix\n{info['description']}```",
                                        ...
                                        "footer": {
                                            "text": f"Dév by T A K#4258 pour Centrale Montmartre !",
                                            "icon_url": "https://media.discordapp.net/attachments/868897295540826224/956250968499040307/182205772_150344853763531_8711038475481521603_n.png"
                                        }
                                    }]}
                        try:
